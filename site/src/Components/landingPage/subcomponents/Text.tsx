...
export default function Text() {
    return (
        <div className="bg-bg-primary relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
                ...
                <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    <div className="mt-20 lg:pr-4">
                        <div className="lg:max-w-lg">
                            ...
                            <h1 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">A better learning curve!</h1>
                            ...
                            <ul role="list" className="mt-8 space-y-8 text-white">
                                <li className="flex gap-x-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="orange"
                                         className="bi bi-fire ml-2 mt-1"
                                         viewBox="0 0 16 16">
                                        <path
                                            d="M8 16c3.314 0 6-2 6-5.5 0-1.5-.5-4-2.5-6 .25 1.5-1.25 2-1.25 2C11 4 9 .5 6 0c.357 2 .5 4-2 6-1.25 1-2 2.729-2 4.5C2 14 4.686 16 8 16m0-1c-1.657 0-3-1-3-2.75 0-.75.25-2 1.25-3C6.125 10 7 10.5 7 10.5c-.375-1.25.5-3.25 2-3.5-.179 1-.25 2 1 3 .625.5 1 1.364 1 2.25C11 14 9.657 15 8 15"/>
                                    </svg>
                                    <span>
                                    <strong className="font-semibold text-white">Keep going!</strong> Do not miss a task!
                                    </span>
                                </li>
                                <li className="pl-3 flex gap-x-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                         className="bi bi-book mt-2" viewBox="0 0 16 16">
                                        <path
                                            d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/>
                                    </svg>
                                    <span>
                                    <strong className="font-semibold text-white">Error</strong> Learn from your mistakes!
                                    </span>
                                </li>
                                <li className="pl-3 flex gap-x-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue"
                                         className="bi bi-rocket-takeoff-fill mt-2" viewBox="0 0 16 16">
                                        <path
                                    ...
                                    <strong className="font-semibold text-white">Be in control!</strong> Learn in your own pace with AI!
                                    </span>
                                </li>
                            </ul>
                        </div>
