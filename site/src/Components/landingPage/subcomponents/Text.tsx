...
export default function Text() {
    return (
        <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible ">

            <div className="mx-auto grid max-w-2xl gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:items-start lg:gap-y-10">
                <div className="lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:gap-x-8 lg:px-8">

                    <div className="flex justify-center lg:pr-4">
                        <div className="lg:max-w-lg">
                            <p className="text-base font-semibold leading-7 text-indigo-600">Learn
                                Sign Language with AI!</p>

                            <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">A better
                                learning curve</h1>
                            <p className="mt-6 text-xl leading-8 text-gray-700">
                                Learn Sign Language with AI - A Duolingo-like experience tailored for sign language
                                learning
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex justify-center lg:row-start-2 lg:mx-auto lg:w-full lg:max-w-7xl lg:gap-x-8 lg:px-8">
